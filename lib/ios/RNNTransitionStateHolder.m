...
-(instancetype)initWithDict:(NSDictionary *)transition {
	...
	self.startAlpha = [RNNUtils getDoubleOrKey:transition[@"alpha"] withKey:@"from" withDefault:1];
	self.endAlpha = [RNNUtils getDoubleOrKey:transition[@"alpha"] withKey:@"to" withDefault:1];
